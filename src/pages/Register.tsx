    ...
    <div className="min-h-screen bg-app-background dark flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-app-surface rounded-2xl p-8 shadow-card">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-app-text-secondary">Crie sua conta</p>
        </div>

        {/* Register Form */}
        <form onSubmit={handleRegister} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="name" className="text-app-text-primary">Nome</Label>
            <Input
              id="name"
              type="text"
              value={name}
          ...
          <div className="space-y-2">
            <Label htmlFor="password" className="text-app-text-primary">Senha</Label>
            <Input
              id="password"
              type="password"
              value={password}
          ...
          <div className="space-y-2">
            <Label htmlFor="confirmPassword" className="text-app-text-primary">Confirmar Senha</Label>
            <Input
              id="confirmPassword"
              type="password"
